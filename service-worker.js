...
const CACHE_NAME = "quiet-camera-shell-v16";
const APP_SHELL = [
  "./",
  "./index.html",
  "./privacy.html",
  "./styles.css?v=20260815.2",
  "./fullscreen.css?v=20260815.2",
  "./camera-enhancements.css?v=20260815.2",
  "./storage.js?v=20260815.2",
  "./core.js?v=20260815.2",
  "./photo.js?v=20260815.2",
  "./video.js?v=20260815.2",
  "./ui.js?v=20260815.2",
  "./fullscreen.js?v=20260815.2",
  "./camera-enhancements-core.js?v=20260815.2",
  "./camera-devices.js?v=20260815.2",
  "./camera-controls.js?v=20260815.2",
  "./camera-capture.js?v=20260815.2",
  "./camera-enhancements.js?v=20260815.2",
  "./manifest.webmanifest?v=20260815.2",
  "./icons/icon.svg",
  "./icons/icon-192.png",
  "./icons/icon-512.png",
